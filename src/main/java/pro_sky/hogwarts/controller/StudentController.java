...
public class StudentController {
    ...
    public ResponseEntity<String> uploadAvatar(@PathVariable Long student_id,
        ...
        avatarService.uploadAvatar(student_id, file);
        return ResponseEntity.ok().build();
    }


    @GetMapping(value = "/{id}/avatar/preview")
    public ResponseEntity<AvatarDto> downloadAvatarPreview(@PathVariable Long id) {
        return ResponseEntity.ok(avatarService.findAvatarById(id));
    }
